...
class CustomerPhoneAuthDrop extends StatefulWidget {
  @override
  _CustomerPhoneAuthDropState createState() => _CustomerPhoneAuthDropState();
}

class _CustomerPhoneAuthDropState extends State<CustomerPhoneAuthDrop> {
  ...
  void _signInWithPhoneNumber(String smsCode) async {
    ...
    _firebaseAuth.signInWithCredential(_authCredential).catchError((error) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => CustomerDropPackage()));
    });
  }
