...
class CustomerPhoneAuthShop extends StatefulWidget {
  @override
  _CustomerPhoneAuthShopState createState() => _CustomerPhoneAuthShopState();
}

class _CustomerPhoneAuthShopState extends State<CustomerPhoneAuthShop> {
  ...
  void _signInWithPhoneNumber(String smsCode) async {
    _showProgressDialogForOTP(context);
  ...
  _showProgressDialogForOTP(BuildContext context) {
    return showDialog(
        context: context,
