...
class TiffinServiceAgent extends StatefulWidget {
  @override
  _TiffinServiceAgentState createState() => _TiffinServiceAgentState();
}

class _TiffinServiceAgentState extends State<TiffinServiceAgent> {
    ...
    _firestore.getDocuments().then((order) {
      ...
      for (var tiffin in order.documents) {
        if (tiffin.data['agentId'] == agentId &&
            ...
            tiffin.data['serviceType'] == "Tiffin Service") {
          setState(() {
            checkOrder = 2;
